...
//                     className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors group border border-gray-200"
//                   >
//                     <div className="flex items-center gap-3">
//                       <div className={`p-2 rounded-lg bg-white border border-gray-300 group-hover:border-blue-500`}>
//                         <item.icon className="w-5 h-5 text-gray-600 group-hover:text-blue-600" />
//                       </div>
//                       <div>
//                         <span className="text-gray-800 group-hover:text-blue-700 font-medium block">
//                           {item.label}
//                         </span>
