  ...
  const handleStatusChange = (newStatus) => {
    ...
    if (newStatus === 'rejected') {
      ...
      if (!rejectionReason.trim()) {
        alert('Rejection reason is required when rejecting a job.');
        return;
      }
    }
    ...
    setModalConfig({
      ...
      onConfirm: async () => {
        try {
          ...
          await dispatch(changeJobStatus(payload)).unwrap();
            ...
            {user.role === 'admin' && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  ...
                  {currentJob.status === 'rejected' && currentJob.rejectionReason && (
                    <div className="mt-3">
